...
if ( ! empty( $instance['image'] ) ) {
	...
	$image_output = sprintf( '<img class="%s" src="%s" alt="%s" title="%s" />', 'ankyler-widget-image', $image_properties[0], esc_attr( $instance['title'] ), esc_attr( $instance['title'] ) );
...
if ( ! empty( $instance['title'] ) ) {
	...
	$title_output = '';
	$title_output .= $before_title . esc_attr( $title ) . $after_title;
